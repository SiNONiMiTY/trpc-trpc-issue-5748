<script lang="ts">
    ...
    let confirmModalPassword: Modal
    let successModalPasswordMember: Modal
    ...
    onMount(() => {
        confirmModalPassword = new Modal(
            document.getElementById(
                `confirmModalPasswordElem${formData.userId}`,
            ),
            {
        ...
        successModalPasswordMember = new Modal(
            document.getElementById(
                `successModalPasswordMemberElem${formData.userId}`,
            ),
            {
                placement: 'bottom-right',
                backdrop: 'static',
    ...
    const handleUpdateBtn = async () => {
        const validatorPassword =
            await updatePasswordInputSchema.safeParseAsync({
                ...formData,
            })
    ...
    const handleConfirmYesBtn = async () => {
        try {
            ...
            confirmModalPassword.hide()
            successModalPasswordMember.show()
        } catch (err) {
    ...
    const handleSuccessContinueBtn = () => {
        closeModal()
        confirmModalPassword.hide()
        successModalPasswordMember.hide()
    }
</script>
...
<div
    id="confirmModalPasswordElem{formData.userId}"
    tabindex="-1"
    ...
    <div class="relative max-h-full w-full max-w-md p-4">
        <div class="relative rounded-lg bg-white shadow dark:bg-gray-700">
            <div class="p-4 text-center md:p-5">
                ...
                <button
                    on:click={() => confirmModalPassword.hide()}
                    type="button"
...
<div
    id="successModalPasswordMemberElem{formData.userId}"
    tabindex="-1"
    aria-hidden="true"
