<script lang="ts">
    ...
    let userTransaction: TRouterOutput['transaction']['getUserTransaction'] = {
        paginatedUserTransaction: [],
        totalNumberOfUserTransaction: 0,
    }

    let paginatedUserTransaction = userTransaction.paginatedUserTransaction
    ...
    const getTransactionListTableData = (
        pn = pageNumber,
        rpp = rowsPerPage,
        sf = searchFilter,
        fd = fromDate,
    ...
    const getTransactionList = async () => {
        userTransaction =
            await $trpcClient.transaction.getUserTransaction.query({
        ...
        if (userTransaction) {
            paginatedUserTransaction = userTransaction.paginatedUserTransaction
            totalItems = userTransaction.totalNumberOfUserTransaction
                    ...
                    <form class="flex items-center">
                        ...
                        <div class="relative w-full">
                            ...
                            <input
                                type="text"
                                id="simple-search"
                                class="focus:ring-primary-500 focus:border-primary-500 dark:focus:ring-primary-500 dark:focus:border-primary-500 block w-full rounded-lg border border-neutral-300 bg-neutral-50 p-2 pl-10 text-sm text-neutral-900 dark:border-neutral-600 dark:bg-neutral-700 dark:text-gray-300 dark:placeholder-neutral-400"
                                placeholder="Search"
                ...
                >
                    <div class="items-center sm:mx-auto">
                        <input
                            ...
                            class=" focus:ring-primary-500 focus:border-primary-500 dark:focus:ring-primary-500 dark:focus:border-primary-500 block w-full rounded-lg border border-neutral-300 bg-gray-50 p-2.5 text-neutral-900 sm:text-sm dark:border-neutral-600 dark:bg-neutral-700 dark:text-neutral-300 dark:placeholder-neutral-400"
                        />
                    </div>
                    <span class="mx-4 text-neutral-800 dark:text-neutral-300"
                        >to</span
                    >
                    <div class="items-center sm:mx-auto">
                        <input
                    ...
                    <div class="inline-block w-full align-middle">
                        <div class="overflow-x-auto">
                            ...
                            >
                                ...
                                >
                                    {#each paginatedUserTransaction as row}
                                        <tr
